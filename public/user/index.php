        ...
        <nav class="bg-transparent p-3 shadow-md">
            <div class="container mx-auto flex justify-between items-center">
                ...
                <div class="flex space-x-3">
                    <a href="#" class="text-black hover:text-purple-300 px-2 py-2 rounded-md text-xs font-medium transition duration-200 ease-in-out transform hover:scale-105">Beranda</a>
                    <a href="#" class="text-black hover:text-purple-300 px-2 py-2 rounded-md text-xs font-medium transition duration-200 ease-in-out transform hover:scale-105">Film</a>
                    <a href="#" class="text-black hover:text-purple-300 px-2 py-2 rounded-md text-xs font-medium transition duration-200 ease-in-out transform hover:scale-105">Tentang</a>
                    <a href="#" class="text-black hover:text-purple-300 px-2 py-2 rounded-md text-xs font-medium transition duration-200 ease-in-out transform hover:scale-105">Kontak</a>
                </div>
            </div>
        </nav>
        <div class="bg-white">
