            ...
            <tbody>
                <?php foreach ($films as $film): ?>
                    <tr
                        ...
                        <td class='px-6 py-4'><button class="details-btn" data-sinopsis="<?= $film['sinopsis'] ?>"
                                data-gambar="<?= $film['gambar'] ?>">Details</button></td>
                        <td class='px-6 py-4'><?= $film['tanggal_rilis'] ?></td>
                        <td class='px-6 py-4'>Rp <?= number_format($film['harga_tiket'], 0, ',', '.') ?></td>
                        <td class='px-6 py-4'><a href='#' class='font-medium text-blue-600 hover:underline'>Edit</a></td>
                        <td class='px-6 py-4'>
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="number" name="durasi" id="durasi"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Durasi film dalam menit" required="">
                        </div>
                        <div>
                            <label for="sutradara"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Sutradara</label>
                        ...
                        <div>
                            ...
                            <textarea name="sinopsis" id="sinopsis" rows="4"
                                ...
                                placeholder="Tulis sinopsis film di sini"></textarea>
                        </div>
                        <div>
                        ...
                        <div>
                            <label for="harga_tiket"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Harga Tiket</label>
                            <input type="number" name="harga_tiket" id="harga_tiket"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Harga tiket film" required="">
                        </div>
                    </div>
                    <button type="submit"
                        class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-700 dark:hover:bg-blue-500 dark:focus:ring-gray-500">
